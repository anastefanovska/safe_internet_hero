      ...
      body: Column(
        children: [
          ...
          const TabHeader(
            ...
            subtitle: 'Help review and grow the quiz',
  ...
  Widget _body(ModeratorStatus status) {
    if (status == ModeratorStatus.pending) {
      return const _StatusMessage(
        ...
        message: 'An admin is reviewing your request. You\'ll be notified once '
            'there\'s a decision.',
      );
    }
      ...
      children: [
        AppCard(
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Text(
              'Moderators can submit new quiz questions. An admin reviews each '
        ...
        if (status == ModeratorStatus.rejected && !e.isEligible)
          Padding(
            ...
            child: Text(
              'Your previous request was declined. Keep going — you can apply '
              'again once you meet the requirements.',
              style: GoogleFonts.nunito(
        ...
        if (e.isEligible)
          AppButton(
            label: _submitting ? 'Sending...' : 'Request moderator access',
          ...
          Container(
            ...
            child: Row(children: [
              ...
              Expanded(
                child: Text(
                  'Keep learning to unlock the request button.',
                  style: GoogleFonts.nunito(
